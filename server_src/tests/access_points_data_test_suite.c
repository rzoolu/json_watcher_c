...
static void* create_map_with_entry(const MunitParameter UNUSED(params[]), void* UNUSED(user_data))
{
...
static MunitResult create_delete_map_test(const MunitParameter UNUSED(params[]), void* UNUSED(user_data_or_fixture))
{
    access_point_map* new_map = create_access_point_map();
...
static MunitResult set_and_get_map_test(const MunitParameter UNUSED(params[]), void* UNUSED(user_data_or_fixture))
{
    access_point_map* new_map = create_access_point_map();
...
static MunitResult add_to_map_test(const MunitParameter UNUSED(params[]), void* UNUSED(user_data_or_fixture))
{
...
static MunitResult find_in_map_test(const MunitParameter UNUSED(params[]), void* UNUSED(user_data_or_fixture))
{
    access_point ap = {.ssid = "some_ssid",
                       .channel = 1u,
                       .SNR = 10u};
...
static MunitResult detect_changed_ssid_test(const MunitParameter UNUSED(params[]), void* fixture)
{
...
static MunitResult detect_param_changes_test(const MunitParameter UNUSED(params[]), void* UNUSED(fixture))
{
...
static MunitTest access_points_data_tests[] =
    {
...
const MunitSuite access_points_data_test_suite = {
    .prefix = "",
