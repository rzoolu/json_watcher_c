...
MunitResult create_delete_map_test(const MunitParameter UNUSED(params[]), void* UNUSED(user_data_or_fixture))
{
    access_point_map* new_map = create_access_point_map();
...
MunitResult set_and_get_map_test(const MunitParameter UNUSED(params[]), void* UNUSED(user_data_or_fixture))
{
    access_point_map* new_map = create_access_point_map();
...
MunitResult add_to_map_test(const MunitParameter UNUSED(params[]), void* UNUSED(user_data_or_fixture))
{
...
MunitResult find_in_map_test(const MunitParameter UNUSED(params[]), void* UNUSED(user_data_or_fixture))
{
    access_point ap = {.ssid = "some_ssid",
                       .channel = 1u,
                       .SNR = 10u};
...
MunitResult detect_changed_ssid_test(const MunitParameter UNUSED(params[]), void* fixture)
{
...
MunitResult detect_param_changes_test(const MunitParameter UNUSED(params[]), void* UNUSED(fixture))
{
